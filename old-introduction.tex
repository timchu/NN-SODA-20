...
%% nearest-neighbor geodesic), when the point set lives in constant dimensional space.
...
%% nearest-neighbor geodesic distance is a distance based on geodesics through the
