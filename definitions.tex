...
\vspace{3 mm}
\noindent \textbf{Nearest Neighbor Metric:}
  Another metric on the points of $P$ is called the Nearest Neighbor Metric,  and is denoted $\dist_N$.
This distance was first defined and studied
  ...
  \begin{definition}
    The Nearest Neighbor Metric distance is defined as:
  \[
  ...
  Nearest Neighbor Metric distance is never greater than the
